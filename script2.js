...
function background() {
  ...
  document.getElementById("background1").style.backgroundPositionX = backgroundPositionX + "px";
}
// End - Background move
...
function createBoxes() {
  for (var i = 0; i < 12; i++) {
    ...
    document.getElementById("background1").appendChild(box);
  }
}
// End - Create boxes
...
function creatfire() {
  for (var i = 0; i < 10; i++) {
    ...
    fireMarginLeft = fireMarginLeft + 1200; 
    fire.style.marginLeft = fireMarginLeft + "px";

    document.getElementById("background1").appendChild(fire);
  }
}
// End - create boxes
